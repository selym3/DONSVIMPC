...
def main(outfile: str, num_points: int, preview: bool):
    ...
    waypoints = np.array(
        [
            ...
            [10.0, 55.0],  # Technical "chicane" exit
    ...
    if preview:
        ...
        axs[0].plot(
            waypoints[:, 0], waypoints[:, 1], "ko", label="Waypoints", alpha=0.5
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-n", "--num_points", type=int, default=500
    )  # Increased default for longer track
